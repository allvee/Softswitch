...
function save_ch_conf() {
	...
	value_arr["rate_code_enabled"] = "input[name='rate_code_enabled']:checked";

	value_arr["parallel_cg_status"] = "input[name='parallel_cg_status']:checked";
...
function save_sa_ivr_serverinfo() {
	var action = get_value("#action");
	var action_id = null;
	...
	var value_arr = {};
	value_arr["server_name"] = "#srvr_name";
	value_arr["db_server"] = "#db_host";
	value_arr["db_uid"] = "#db_user";
	value_arr["db_password"] = "#db_pswrd";
	value_arr["db_name"] = "#db_name";
	value_arr["prompt_location"] = "#prmpt_location";
	value_arr["web_service_url"] = "#web_service_url";
	value_arr["recording_location"] = "#recording_location";


	save_files(action, action_id, "modules/sa/submit_sa_IvrServerInfo", value_arr, null, null, null, null, null);
	set_value("action", "insert", selector_type_id);
	pagination("sa_ivr_info", ["srvr_name", "db_host", "db_user", "db_pswrd", "db_name", "prmpt_location", "web_service_url", "recording_location"], "report/view_sa_IvrServerInfo", null, null);
}
