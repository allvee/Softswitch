...
$domain_name_server1 = mysql_real_escape_string(htmlspecialchars($_REQUEST['domain_name_server1']));
$domain_name_server2 = mysql_real_escape_string(htmlspecialchars($_REQUEST['domain_name_server2']));
