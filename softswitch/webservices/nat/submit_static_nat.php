...
if ($action == "insert") {
    $qry = "insert into tbl_nat_static (last_updated, last_updated_by, ";
    $values = "'$last_updated','$last_updated_by',";
} elseif ($action == "update") {
    $qry = "update tbl_nat_static set last_updated='$last_updated', last_updated_by='$last_updated_by',";
} elseif ($action == "delete") {
    $qry = "update tbl_nat_static set is_active='inactive',last_updated='$last_updated', last_updated_by='$last_updated_by' where is_active='active' and id='$action_id'";
}
