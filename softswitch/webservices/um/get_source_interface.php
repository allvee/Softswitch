...
require_once "../lib/common.php";
	$cn = connectDB();
	$options = '';
	$select_interface = "SELECT interface_name FROM tbl_interface 
						 WHERE bridge='no' AND is_active='active' AND (vlan='yes' OR vlan='none') ORDER BY interface_name asc";
	...
	$select_bridge = "SELECT bridge_name FROM tbl_bridge WHERE is_active='active' order by bridge_name";
